...
public class Morphing {
    ...
    private boolean calculated,sourceSet, targetSet,sourceCenterSet, targetCenterSet;
    Morphing(){
    ...
    HashMap<Point2D, Point2D> getMorph(){
        assert sourceSet==true: "source polygon not set";
        assert sourceCenterSet==true: "sourceCenter not set";
        assert targetSet==true: "targetCenter not set";
        assert targetCenterSet==true: "target center not set";
